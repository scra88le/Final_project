...
An exploratory data analysis was undertaken on the SBBS dataset as per the protocol outlined in Zuur [@Zuur2010-kp]. In addition survey locations were plotted spatially across each survey year in order to gauge survey effort. Outliers were removed etc etc etc.
