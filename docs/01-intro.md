...
|:---|:-----------------------------------------------|:--------------|
|**H1**| Farmland that is managed as improved grassland for silage has a higher pH, possibly due to liming and fertilisation, which in turn is associated with higher earthworm density [@McCallum2016-jt] | Positive | Scale |
...
Having quantified and evaluated the response of breeding wader abundance against the study hypotheses as outlined in Table \@ref(tab:waderHypo), a population model will be developed to quantify the populations and spatial distribution of farmland breeding waders from 2002-2019, acros Shetland (excluding Foula and Fair Isle). 
