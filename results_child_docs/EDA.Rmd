...
```{r spatSum,fig.asp = 0.8, fig.width = 8,message=FALSE, warning=FALSE, echo=FALSE, fig.align='center', fig.cap='Locations and sampling effort of Shetland Breeding Bird Survey, for farmland wader species. Number of years a SBBS 1km square was survyered (n), between 2002 and 2019'}
...
```{r countDotPlot, message=FALSE, warning=FALSE, echo=FALSE, fig.align='center', fig.cap='Cleveland dot plot of species counts in Shetland BBS data from 2002 to 2019 '}
...
```{r normSig, echo=FALSE, message=FALSE, warning=FALSE}
...
survey_BBS_2002_2018 %>%
  ...
  knitr::kable(
    ...
    booktabs = TRUE,
    caption = "Shapiro-Wilks normality test for count data of breeding waders"
  )
...
```{r zipTest, message=FALSE, warning=FALSE, echo=FALSE}
...
zip_test_res %>%
  ...
  knitr::kable(
    ...
    booktabs = TRUE,
    caption = 'Zero inflation poisson distribution test for Shetland SBBS count data, across all years and species'
  )
