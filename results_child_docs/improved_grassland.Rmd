...
```{r satBands, echo=FALSE, fig.cap='Sentinel 2 spectral bands' , message=FALSE, warning=FALSE}
# Sentinel 2 Bands, central wavelength(micrometre), all at 10m resolution
sensors <- data.frame(
...
```{r modelResults, echo=FALSE, fig.cap='SVM model parameters from best fitting models', message=FALSE, warning=FALSE}
...
```{r evalPerf, echo=FALSE, fig.cap='Classifier performance using test data set', message=FALSE, warning=FALSE}
