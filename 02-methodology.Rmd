...
```{r eunisTable, echo=FALSE, message=FALSE, warning=FALSE}
library(knitr)
library(tidyverse)
...
```{r satBands, echo=FALSE, message=FALSE, warning=FALSE}
...
sensors %>% 
  knitr::kable(
    ...
    booktabs = TRUE,
    caption = 'Sentinel 2 MSI Level 2A spectral bands used to train a support vector machine classifier for improved grassland habitat'
  )
```
