...
![](99-appendix_files/figure-docx/plotCovars-1.png)<!-- -->
...
![(\#fig:responsePlots1)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-1.png)![(\#fig:responsePlots2)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-2.png)![(\#fig:responsePlots3)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-3.png)![(\#fig:responsePlots4)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-4.png)![(\#fig:responsePlots5)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-5.png)
...
![(\#fig:responsePlots6)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-6.png)![(\#fig:responsePlots7)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-7.png)![(\#fig:responsePlots8)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-8.png)![(\#fig:responsePlots9)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-9.png)![(\#fig:responsePlots10)Plots show abundance response to environmental covariates for a GAM](99-appendix_files/figure-docx/responsePlots-10.png)
...
![(\#fig:popChgPlots1)Plots show population change to environmental covariates for a GAM, acrossall wader species](99-appendix_files/figure-docx/popChgPlots-1.png)![(\#fig:popChgPlots2)Plots show population change to environmental covariates for a GAM, acrossall wader species](99-appendix_files/figure-docx/popChgPlots-2.png)![(\#fig:popChgPlots3)Plots show population change to environmental covariates for a GAM, acrossall wader species](99-appendix_files/figure-docx/popChgPlots-3.png)![(\#fig:popChgPlots4)Plots show population change to environmental covariates for a GAM, acrossall wader species](99-appendix_files/figure-docx/popChgPlots-4.png)![(\#fig:popChgPlots5)Plots show population change to environmental covariates for a GAM, acrossall wader species](99-appendix_files/figure-docx/popChgPlots-5.png)
...
![(\#fig:itResponsePlots1)Plots show abundance response to information theory covariates for a GAM](99-appendix_files/figure-docx/itResponsePlots-1.png)![(\#fig:itResponsePlots2)Plots show abundance response to information theory covariates for a GAM](99-appendix_files/figure-docx/itResponsePlots-2.png)![(\#fig:itResponsePlots3)Plots show abundance response to information theory covariates for a GAM](99-appendix_files/figure-docx/itResponsePlots-3.png)
...
![(\#fig:itResponsePlots4)Plots show abundance response to information theory covariates for a GAM](99-appendix_files/figure-docx/itResponsePlots-4.png)![(\#fig:itResponsePlots5)Plots show abundance response to information theory covariates for a GAM](99-appendix_files/figure-docx/itResponsePlots-5.png)![(\#fig:itResponsePlots6)Plots show abundance response to information theory covariates for a GAM](99-appendix_files/figure-docx/itResponsePlots-6.png)
...
![(\#fig:itPopChgPlots1)Plots show population change to information theory covariates for a GAM, across all wader species](99-appendix_files/figure-docx/itPopChgPlots-1.png)![(\#fig:itPopChgPlots2)Plots show population change to information theory covariates for a GAM, across all wader species](99-appendix_files/figure-docx/itPopChgPlots-2.png)![(\#fig:itPopChgPlots3)Plots show population change to information theory covariates for a GAM, across all wader species](99-appendix_files/figure-docx/itPopChgPlots-3.png)
...
![(\#fig:showTuneResults1)Root mean squared evaluation of hyper parameters across all species](99-appendix_files/figure-docx/showTuneResults-1.png)
...
![(\#fig:showTuneResults2)Root mean squared evaluation of hyper parameters across all species](99-appendix_files/figure-docx/showTuneResults-2.png)
...
![(\#fig:showTuneResults3)Root mean squared evaluation of hyper parameters across all species](99-appendix_files/figure-docx/showTuneResults-3.png)
...
![(\#fig:showTuneResults4)Root mean squared evaluation of hyper parameters across all species](99-appendix_files/figure-docx/showTuneResults-4.png)
...
![(\#fig:showTuneResults5)Root mean squared evaluation of hyper parameters across all species](99-appendix_files/figure-docx/showTuneResults-5.png)
...
![](99-appendix_files/figure-docx/plotRetuneResults-1.png)<!-- -->
...
![](99-appendix_files/figure-docx/plotRetuneResults-2.png)<!-- -->
...
![](99-appendix_files/figure-docx/plotRetuneResults-3.png)<!-- -->
...
![](99-appendix_files/figure-docx/plotRetuneResults-4.png)<!-- -->
...
![](99-appendix_files/figure-docx/plotRetuneResults-5.png)<!-- -->
...
![(\#fig:varImpPlots1)Variable Importance Plot of Abundance Model by Species](99-appendix_files/figure-docx/varImpPlots-1.png)
...
![(\#fig:varImpPlots2)Variable Importance Plot of Abundance Model by Species](99-appendix_files/figure-docx/varImpPlots-2.png)
...
![(\#fig:varImpPlots3)Variable Importance Plot of Abundance Model by Species](99-appendix_files/figure-docx/varImpPlots-3.png)
...
![(\#fig:varImpPlots4)Variable Importance Plot of Abundance Model by Species](99-appendix_files/figure-docx/varImpPlots-4.png)
...
![(\#fig:varImpPlots5)Variable Importance Plot of Abundance Model by Species](99-appendix_files/figure-docx/varImpPlots-5.png)
